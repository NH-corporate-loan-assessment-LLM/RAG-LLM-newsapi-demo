...
class NewsRagPipeline:
    """News RAG Pipeline following Discord Chatbot pattern"""
    
    def __init__(self, openrouter_api_key: str, newsapi_key: str, index_dir: str):
    ...
    def analyze_article_impact(self, article_data: Dict[str, Any], company_profile: Dict[str, Any]) -> Dict[str, Any]:
        """Analyze the impact of the selected article"""
